             ...
             match &event.logical_key {
                 Key::Space => {
                     ...
                     if let Some((start, end)) = text_field.selection_range() {
                         ...
                         text_field.text.replace_range(start_byte_pos..end_byte_pos, " ");
                 ...
                 Key::Character(c) => {
                     ...
                     if let Some((start, end)) = text_field.selection_range() {
                         ...
                         text_field
                             .text
                             .replace_range(start_byte_pos..end_byte_pos, chars.iter().collect::<String>().as_str());

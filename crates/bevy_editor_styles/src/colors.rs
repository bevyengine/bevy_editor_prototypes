//! Color constants for simple theming - only to be used until we can move toward `bevy_feathers`
//!
//! These colors are derived from the Figma design specifications and provide
//! a consistent dark theme across the editor interface - check the CSS from the Figma design
//! for reference
//!
//! ## Usage
//!
...
impl EditorColors {
    ...
    pub const AXIS_X: Color = Color::srgb(0.671, 0.251, 0.320);
